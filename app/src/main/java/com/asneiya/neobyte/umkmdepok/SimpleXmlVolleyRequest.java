 ...
 * Ref: https://gist.github.com/itsalif/6149365
 */
public class SimpleXmlVolleyRequest<T> extends Request<T> {
     ...
     *
     * @see SimpleXmlVolleyRequest#SimpleXmlVolleyRequest(int, String, Class, Map, Listener, ErrorListener)
     */
    public SimpleXmlVolleyRequest(int method, String url, Class<T> clazz,
     ...
     *
     */
    public SimpleXmlVolleyRequest(int method, String url, Class<T> clazz, Map<String, String> headers,
                                  Listener<T> listener, ErrorListener errorListener) {
